...
export default function OverviewTab() {
  ...
  // A UTC day names yesterday between midnight and 07:00 Bangkok, which would
  // ask every card on this page for the wrong day's figures.
