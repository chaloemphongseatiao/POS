...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn("flex h-full w-full flex-col overflow-hidden rounded-xl bg-white text-gray-900", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-gray-100 px-3 focus-within:ring-2 focus-within:ring-inset focus-within:ring-ring">
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn("p-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-gray-400", className)}
    {...props}
  />
));
