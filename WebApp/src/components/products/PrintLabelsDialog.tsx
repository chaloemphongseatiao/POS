...
export default function PrintLabelsDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        <DialogHeader>
          <div className="flex flex-wrap items-center justify-between gap-3 pr-8">
            <div>
              <DialogTitle>พิมพ์ฉลาก Barcode</DialogTitle>
              <p className="text-sm text-slate-500">Barcode Label Printing</p>
            </div>
